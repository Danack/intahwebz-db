...
class EmailUserJoinTableDTO {
     ...
     * @param $emailUserJoinTable \Intahwebz\TableMap\Tests\EmailUserJoinTable
     * @return int
     */
    function insertInto(\Intahwebz\TableMap\SQLQuery $query, \Intahwebz\TableMap\Tests\EmailUserJoinTable $emailUserJoinTable){
