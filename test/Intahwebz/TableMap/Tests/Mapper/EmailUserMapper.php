...
class EmailUserMapper {
    ...
    function __construct(
        ...
        \Intahwebz\TableMap\Tests\Table\UserTable $userTable,
        \Intahwebz\TableMap\Tests\Table\EmailTable $emailSQLTable,
        \Intahwebz\TableMap\Tests\Table\EmailUserJoinTable $emailUserJoinTable
        ) {
