...
class UserTableDTO {
     ...
     * @param $userTable \Intahwebz\TableMap\Tests\Table\UserTable
     * @return int
     */
    function insertInto(\Intahwebz\TableMap\SQLQuery $query, \Intahwebz\TableMap\Tests\Table\UserTable $userTable){
